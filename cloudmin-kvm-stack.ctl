...
Suggests: awscli, bzip2, certbot, cron, etckeeper, fail2ban, firewalld, lm-sensors, logrotate, p7zip-full, parted, libconfig-inifiles-perl, libio-tty-perl, postfix, python-is-python3, rsync, tar, whois, xz-utils
Architecture: any
